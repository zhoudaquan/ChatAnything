...
class AnimateFromCoeff():
    ...
    def generate(self, x, video_save_dir, pic_path, crop_info, enhancer=None, background_enhancer=None, preprocess='crop', img_size=256):
        ...
        # try:
        #     enhanced_images_gen_with_len = enhancer_generator_with_len(path, method='gfpgan', bg_upsampler='realesrgan')
        #     imageio.mimsave(path, enhanced_images_gen_with_len, fps=float(25))
        # except:
        #     enhanced_images_gen_with_len = enhancer_list(path, method='gfpgan', bg_upsampler='realesrgan')
        #     imageio.mimsave(path, enhanced_images_gen_with_len, fps=float(25))
