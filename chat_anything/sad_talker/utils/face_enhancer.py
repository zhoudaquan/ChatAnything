...
from chat_anything.sad_talker.utils.videoio import load_video_to_cv2
...
def process_frame(img,restorer):  
    # restore faces and background if necessary
    cropped_faces, restored_faces, r_img = restorer.module.enhance(
        img,
        has_aligned=False,
